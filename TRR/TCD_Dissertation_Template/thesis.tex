...
\renewcommand{\thesisauthor}{Tung-te Lin}            %% Your official TCD name.
\renewcommand{\thesismonth}{11}                  %% Your month of graduation.
\renewcommand{\thesisyear}{2020}                      %% Your year of graduation.
\renewcommand{\thesistitle}{Produce a technical plan for an "Irish" TRR}            %% The title of your thesis; use mixed-case.
...
\renewcommand{\thesisdegree}{Master of Science in Computer Science}  
                                     ...
                                     %% the degree.
\renewcommand{\thesisdegreestream}{ (Future Networked System)}
